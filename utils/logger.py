...
LOGGING_ENABLED = os.environ.get("KONFIGA_LOGGING_ENABLED", "true").lower() == "true"
LOG_LEVEL = os.environ.get("KONFIGA_LOG_LEVEL", "INFO").upper()
LOG_DIR = os.environ.get("KONFIGA_LOG_DIR", "logs")
