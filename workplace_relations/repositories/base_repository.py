...
class BaseRepository(ABC, Generic[T]):
    ...
    def find_by_date_range(self, date_field: str, start_date: datetime, end_date: datetime) -> List[T]:
    ...
    def find_paginated(self, page: int = 1, page_size: int = 10, filters: Optional[Dict[str, Any]] = None) -> Dict[str, Any]:
