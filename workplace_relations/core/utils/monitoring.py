...
class ScraperMonitor:
    ...
    def finalize(self) -> Dict[str, Any]:
        ...
        return {
            ...
            'success_rate': round(self.metrics.documents_processed / 
                                (self.metrics.documents_processed + self.metrics.documents_failed), 2) 
                                if (self.metrics.documents_processed + self.metrics.documents_failed) > 0 else 1.0,
